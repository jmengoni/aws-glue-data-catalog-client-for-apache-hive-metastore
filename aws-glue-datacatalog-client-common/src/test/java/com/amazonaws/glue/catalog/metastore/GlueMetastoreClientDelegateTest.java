...
public class GlueMetastoreClientDelegateTest {
  ...
  public void setup() throws Exception {
    ...
    metastoreClientDelegateCatalogId = new GlueMetastoreClientDelegate(hiveConfCatalogId,
        new DefaultAWSGlueMetastore(hiveConfCatalogId, glueClient), wh);
  ...
  public void testGetTableWithCatalogId() throws Exception {
    ...
    when(glueClient.getTables(
        new GetTablesRequest().withDatabaseName(testDb.getName()).withExpression("*").withCatalogId(CATALOG_ID)))
        .thenReturn(new GetTablesResult().withTableList(tableList));
  ...
  public void testGetTableMeta() throws Exception {
    ...
    List<TableMeta> tableMetaResult = metastoreClientDelegate.getTableMeta(testDb.getName(), testTbl.getName(),
        tableTypes);
    assertEquals(catalogToHiveConverter.convertTableMeta(testTbl, testDb.getName()),
        Iterables.getOnlyElement(tableMetaResult));
  }
  ...
  public void testCreateTableWithExistingDirWithCatalogId() throws Exception {
    ...
    metastoreClientDelegateCatalogId
        .createTable(catalogToHiveConverter.convertTable(testTbl, testTbl.getDatabaseName()));
  ...
  public void testAlterTable() throws Exception {
    org.apache.hadoop.hive.metastore.api.Table newHiveTable = catalogToHiveConverter.convertTable(getTestTable(),
        testDb.getName());
  ...
  public void testDropTableWithDeleteData() throws Exception {
    ...
    verify(glueClient)
        .deleteTable(new DeleteTableRequest().withDatabaseName(testTbl.getDatabaseName()).withName(testTbl.getName()));
  ...
  public void testValidateTableAndCreateDirectoryVirtualView() throws Exception {
    ...
    org.apache.hadoop.hive.metastore.api.Table hiveTbl = catalogToHiveConverter.convertTable(testTbl,
        testTbl.getDatabaseName());
  ...
  public void testGetPartitionByValues() throws Exception {
    ...
    org.apache.hadoop.hive.metastore.api.Partition result = metastoreClientDelegate.getPartition(testDb.getName(),
        testTbl.getName(), values);
  ...
  public void testGetPartitionByValuesWithCatalogId() throws Exception {
    ...
    GetPartitionRequest request = new GetPartitionRequest()
        .withDatabaseName(testDb.getName())
        .withTableName(testTbl.getName())
        .withPartitionValues(values).withCatalogId(CATALOG_ID);
    when(glueClient.getPartition(request)).thenReturn(new GetPartitionResult().withPartition(partition));
    org.apache.hadoop.hive.metastore.api.Partition result = metastoreClientDelegateCatalogId
        .getPartition(testDb.getName(), testTbl.getName(), values);
  ...
  public void testGetPartitionsByNames() throws Exception {
    ...
    List<org.apache.hadoop.hive.metastore.api.Partition> result = metastoreClientDelegate
        .getPartitionsByNames(testDb.getName(), testTbl.getName(), ImmutableList.of(partitionName));
  ...
  public void testGetPartitionsByNamesWithCatalogId() throws Exception {
    ...
    List<org.apache.hadoop.hive.metastore.api.Partition> result = metastoreClientDelegateCatalogId
        .getPartitionsByNames(testDb.getName(), testTbl.getName(), ImmutableList.of(partitionName));
  ...
  public void testGetPartitionsByNamePropagateException() throws Exception {
    ...
    try {
      metastoreClientDelegate.getPartitionsByNames(testDb.getName(), testTbl.getName(),
          ImmutableList.of("/a=foo/b=bar"));
    } catch (Exception e) {
  ...
  public void testGetPartitionsParallel() throws Exception {
    ...
    GlueMetastoreClientDelegate delegate = new GlueMetastoreClientDelegate(conf,
        new DefaultAWSGlueMetastore(conf, glueClient), wh);
          ...
          public GetPartitionsResult answer(InvocationOnMock invocation) {
            ...
            switch (request.getSegment().getSegmentNumber()) {
              case 0:
                ...
                break;
              case 1:
                result = new GetPartitionsResult()
                    .withPartitions(partitions.subList(numPartitions / 2, partitions.size()));
                break;
              default:
  ...
  public void testAppendPartition() throws Exception {
    ...
    org.apache.hadoop.hive.metastore.api.Partition res = metastoreClientDelegate.appendPartition(testDb.getName(),
        testTbl.getName(), values);
  ...
  public void testAddPartitionsEmpty() throws Exception {
    ...
    List<org.apache.hadoop.hive.metastore.api.Partition> partitionsCreated = metastoreClientDelegate
        .addPartitions(partitions, false, true);
  ...
  public void testAddPartitionsEmptyPartitionLocation() throws Exception {
    ...
    int numPartitions = 2;
    List<org.apache.hadoop.hive.metastore.api.Partition> partitionsCreated = addPartitionsWithEmptyLocationsValid(
        numPartitions);
    verify(wh, times(numPartitions)).mkdirs(any(Path.class));
  ...
  private List<org.apache.hadoop.hive.metastore.api.Partition> addPartitionsWithEmptyLocationsValid(int numPartitions)
      throws Exception {
    List<org.apache.hadoop.hive.metastore.api.Partition> partitions = getTestPartitions(numPartitions);
  ...
  public void testAddPartitions_PartitionViewWithLocation() throws Exception {
    // Case: table location is empty (VIRTUAL_VIEW) with partition containing
    // location
    // In Hive, this throws MetaException because it doesn't allow parititon views
    // to have location
    Table table = testTbl;
  ...
  public void testAddPartitionsDoNotNeedResult() throws Exception {
    ...
    List<org.apache.hadoop.hive.metastore.api.Partition> partitions = getTestPartitions(numPartitions);
    List<org.apache.hadoop.hive.metastore.api.Partition> partitionsCreated = metastoreClientDelegate
        .addPartitions(partitions, false, false);
  ...
  public void testAddPartitionsTwoPagesWithCatalogId() throws Exception {
    ...
    int expectedBatches = 2;
    List<org.apache.hadoop.hive.metastore.api.Partition> partitions = getTestPartitions(numPartitions);
    List<org.apache.hadoop.hive.metastore.api.Partition> partitionsCreated = metastoreClientDelegateCatalogId
        .addPartitions(partitions, false, true);
  ...
  public void testAddPartitionsIfNotExists() throws Exception {
    ...
    List<org.apache.hadoop.hive.metastore.api.Partition> partitions = getTestPartitions(numPartitions);
    List<org.apache.hadoop.hive.metastore.api.Partition> partitionsCreated = metastoreClientDelegate
        .addPartitions(partitions, true, true);
  ...
  public void testAlterParititonDDLTimeUpdated() throws Exception {
    List<String> values = ImmutableList.of("foo", "bar");
    org.apache.hadoop.hive.metastore.api.Partition partition = catalogToHiveConverter
        .convertPartition(getTestPartition(testTbl.getDatabaseName(), testTbl.getName(), values));
    metastoreClientDelegate.alterPartitions(testTbl.getDatabaseName(), testTbl.getName(),
  ...
  public void testListPrivileges() throws Exception {
    ...
    org.apache.hadoop.hive.metastore.api.PrincipalType principalType = org.apache.hadoop.hive.metastore.api.PrincipalType.USER;
  ...
  public void testGetPartitionColumnStatisticsValid() throws Exception {
    ...
    when(glueClient.getColumnStatisticsForPartition(any()))
        .thenReturn(new GetColumnStatisticsForPartitionResult().withColumnStatisticsList(new ArrayList<>()));
  ...
  public void testGetTableColumnStatistics() throws Exception {
    ...
    when(glueClient.getColumnStatisticsForTable(any()))
        .thenReturn(new GetColumnStatisticsForTableResult().withColumnStatisticsList(new ArrayList<>()));
  ...
  public void testUpdatePartitionColumnStatistics() throws Exception {
    org.apache.hadoop.hive.metastore.api.ColumnStatistics columnStatistics = TestObjects
        .getHivePartitionColumnStatistics();

    when(glueClient.updateColumnStatisticsForPartition(any()))
        .thenReturn(new UpdateColumnStatisticsForPartitionResult());
  ...
  public void testUpdateTableColumnStatistics() throws Exception {
    org.apache.hadoop.hive.metastore.api.ColumnStatistics columnStatistics = TestObjects.getHiveTableColumnStatistics();
  ...
  private void assertDaemonThreadPools() {
    String threadNameCreatePrefix = GlueMetastoreClientDelegate.GLUE_METASTORE_DELEGATE_THREADPOOL_NAME_FORMAT
        .substring(
            0,
